...
<%@ page buffer="none"%>
<%@ page
	import="gov.nih.nci.caintegrator.service.findings.*,gov.nih.nci.rembrandt.web.helper.*,gov.nih.nci.rembrandt.web.factory.*,gov.nih.nci.rembrandt.web.bean.*,org.dom4j.Document,gov.nih.nci.rembrandt.util.*"%>
...
<script language="JavaScript" type="text/javascript"
	src="js/overlib_hideform.js"></script>
<script language="JavaScript" type="text/javascript"
	src="js/caIntScript.js"></script>
...
<script type='text/javascript'
	src='/rembrandt/dwr/interface/DynamicReport.js'></script>
<script type='text/javascript'
	src='/rembrandt/dwr/interface/ListFilter.js'></script>
...
<%
		...
		if (request.getParameter("newReport") != null) {
			...
			if (session.getAttribute("tmpReporterList") != null) {
				...
				al = (List) session.getAttribute("tmpReporterList");
		...
		if (session.getAttribute(key + "_xhtml") != null) {
			...
			if (request.getParameter("p_highlight_op") != null)
				p_highlight_op = (String) request
						.getParameter("p_highlight_op");
			...
			if (request.getParameter("p_pval_filter_mode") != null)
				p_pval_filter_mode = (String) request
						.getParameter("p_pval_filter_mode");
			String p_pval_filter_value = "";
			if (request.getParameter("p_pval_filter_value") != null)
				p_pval_filter_value = (String) request
						.getParameter("p_pval_filter_value");

			String p_pval_filter_op = "lt";
			if (request.getParameter("p_pval_filter_op") != null)
				p_pval_filter_op = (String) request
						.getParameter("p_pval_filter_op");

			//for sorting
			String p_sort_method = request.getParameter("p_sort_method") != null ? (String) request
					.getParameter("p_sort_method")
					: "ascending";
			String p_sort_element = request.getParameter("p_sort_element") != null ? (String) request
					.getParameter("p_sort_element")
					: "";

			%>
<div id="imgContainer" style="display:block; position:absolute;"><br />
