 ...
 */
abstract class SelectHandler implements Runnable {
    private ReporterIDCriteria reporterIDCritObj;
    ...
    final static class RegionSelectHandler extends SelectHandler{
       public RegionSelectHandler(ReporterIDCriteria reporterIDCritObj, Collection allProbIDs, Collection allClnIDs, PersistenceBroker _BROKER) {
    ...
    final static class OntologySelectHandler extends SelectHandler{
       public OntologySelectHandler(ReporterIDCriteria reporterIDCritObj, Collection allProbIDs, Collection allClnIDs, PersistenceBroker _BROKER) {
    ...
    final static class GeneIDSelectHandler extends SelectHandler {
       public GeneIDSelectHandler(ReporterIDCriteria reporterIDCritObj, Collection allProbIDs, Collection allClnIDs, PersistenceBroker _BROKER ) {
           super(reporterIDCritObj, allProbIDs, allClnIDs, new DBEvent.GeneIDRetrieveEvent(), _BROKER);
       }
    }

    public SelectHandler(ReporterIDCriteria reporterIDCritObj, Collection allProbIDs, Collection allClnIDs, DBEvent event, PersistenceBroker pb) {
