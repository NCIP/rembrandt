...
public class KaplanMeier {
	...
	public KMDrawingPoint[] getDrawingPoints(ArrayList samples) {
		...
		for (int i = 0; i < samples.size(); i++) {
			...
			System.out.println("Survival time: " + curSurvTime + "\tcensor:"
					+ ((KMSampleInfo) samples.get(i)).getCensor());
		...
		KMDrawingPoint[] kmDrawingPoints = (KMDrawingPoint[]) points
	...
	public static void main(String[] args) {
		...
		kms.add(new KMSampleInfo(2, 1, 0.1));
		kms.add(new KMSampleInfo(3, 1, 0.1));
		kms.add(new KMSampleInfo(3, 1, 3.5));
		kms.add(new KMSampleInfo(4, 0, 1.5));
		kms.add(new KMSampleInfo(4, 1, 0.5));
		kms.add(new KMSampleInfo(5, 0, 0.5));
		kms.add(new KMSampleInfo(6, 1, 0.5));
		kms.add(new KMSampleInfo(7, 1, 3.5));
