   ...
   <xsl:for-each select="Report">
	...
	<xsl:if test="$recordCount > 0">
	    ...
	    <span style="z-index:900; float:right;position:absolute;top:10px;right:10px;">
		  ...
		  <a href="#" onclick="javascript: Help.popHelp('Class_comparison_report');" title="Click here for additional information about this report."><img alt="Help" align="right" src="images/help.png" border="0" /></a>
