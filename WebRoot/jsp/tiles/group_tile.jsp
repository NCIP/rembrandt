...
<a href="javascript:void(0);" onmouseover="return overlib('Select one group for PCA.', CAPTION, 'Help');" onmouseout="return nd();">[?]</a>
</legend>	
	<html:select styleId="selectedGroups" size="5" style="width:200px" property="selectedGroupName">
