...
<app:help help="Paste a comma delimited IMAGE Clone Id/Affymetrix probe set ID list, or upload a tab-delimited file containing the IDs using the browse button. Image IDs must start with “IMAGE:”" />
<% } else { %>
