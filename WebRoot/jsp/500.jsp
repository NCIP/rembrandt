...
<br clear="both"/>
  <strong>Our apologies, 
   there has been an internal server error.</strong>
</p><br /><br /><br />
</fieldset>
<br /><br />
...
<div style="width:765; text-align:center; padding: 3px 0px 10px 0px; background-color:#D5E0E9">
    <a href="menu.action">HOME</a>  |  <a href="http://ncicb.nci.nih.gov/NCICB/support" target="_blank">SUPPORT</a>  |  <a href="http://ncicb.nci.nih.gov" target="_blank">NCICB HOME</a>
